...
4. 每一項危害都要提供：
   ...
   - 風險描述 risk：請使用完整但精簡的查核語句，描述「照片中可見狀況」、「可能造成的事故型態」及「可能影響的人員或作業安全」。請避免只寫抽象危害名稱，也避免過度推測照片外情境。建議 35 至 90 個中文字。
   - 風險級別：高 / 中 / 低
5. 提供改善建議 suggestions：請依照片中辨識到的危害提出具體、可執行且與現場情境相關的改善措施。建議內容應包含立即處置、工程控制、管理控制、教育訓練或個人防護具等方向，但不要空泛寫成「加強宣導」或「注意安全」。每一則建議請使用完整句子，建議 35 至 100 個中文字。
...
JSON 格式如下：
{
  ...
  "suggestions": [
    "具體改善建議，例如：應先清除作業區周邊雜物，維持人員通行與設備操作所需空間，並劃設警示區域或人車分流動線。",
    "具體改善建議，例如：應確認相關防護設施、警示標示與作業前檢點是否完整，並由現場管理人員定期追蹤改善情形。"
  ]
}`;
